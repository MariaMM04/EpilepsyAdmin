...
public class Signal {
     ...
     * @param file      the file compressed where the signal is sent
     * @param date      the date of the recording of the signal
     * @param comments  optional comments regarding the signal
     * @param patientId the foreign key referencing the {@code Patient} (patientId)
     * @param sampleFrequency   the signal's sampling frequency
     */
    public Signal(int id, File file, LocalDate date, String comments, int patientId, double sampleFrequency) {
        this.id = id;
        this.file = file;
        this.date = date;
        this.comments = comments;
     ...
     * @param sampleFrequency   the signal's sampling frequency
     */
    public Signal(File file, LocalDate date, String comments, int patientId, double  sampleFrequency) {
        this.file = file;
        this.date = date;
        this.comments = comments;
        this.patientId = patientId;
    ...
    public JsonObject toJson() {
        ...
        jsonObject.addProperty("sampleFrequency", sampleFrequency);
        return jsonObject;
    }
